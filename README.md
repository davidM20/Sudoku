Este proyecto presenta un juego de Sudoku implementado en lenguaje C. Con el objetivo de mejorar la experiencia de juego, se ha desarrollado una integración de la terminal con el cursor del mouse.
